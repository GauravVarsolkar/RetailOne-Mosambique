      ...
      override fun afterTextChanged(s: Editable?) {
       ...
       /* if(productitem.stock_quantity <= productitem.reorder_level){
        ...
        if (stockQty <= reorderLevel) {
            ...
            holder.binding.itemUnit.text = context.getString(R.string.stock_quantity_prefix, stockQty.toString())
            holder.binding.itemPrice.text = context.getString(R.string.reorder_level_prefix, reorderLevel.toString())
        } else {
...
//        holder.binding.itemPrice.text = formattedPrice
       ...
       // if (productitem.stock_quantity.toInt() > 0) {
        if (true) {
            ...
            holder.binding.itemUnit.text = "${productitem.stock_quantity} ${context.getString(R.string.units_label)}"
            ...
            holder.binding.itemUnit.text = context.getString(R.string.out_of_stock_label)
        ...
        return object : TextWatcher {
            ...
            override fun onTextChanged(s: CharSequence?, start: Int, before: Int, count: Int) {
                ...
                try {
                    ...
                    if (enteredValue == 0) {
                        Toast.makeText(context, context.getString(R.string.error_quantity_zero), Toast.LENGTH_SHORT).show()
                   ...
                   // } else if (enteredValue <= productitem.stock_quantity.toInt()) {
                        ...
                        Toast.makeText(context, context.getString(R.string.error_more_than_stock, productitem.product_name), Toast.LENGTH_SHORT).show()
