...
class StockRequisitionSubmitActivity : BaseActivity() {
        ...
        binding.nextlayout.setOnClickListener {
            ...
            if (updatedList.isNotEmpty()) {
                if (!updatedList.any { it.cart_quantity.toInt() == 0 }) {
                    ...
                    if (finalExposure > actualStoreExposure) {
                       // Toast.makeText(this, "❌ Total exceeds actual store exposure!", Toast.LENGTH_LONG).show()
                        AlertDialog.Builder(this)
                            .setTitle(getString(R.string.error_limit_exceeded))
                            .setMessage(getString(R.string.error_exposure_exceeded, finalExposure.toString(), actualStoreExposure.toString()))
                    ...
                    showMessage(getString(R.string.error_add_at_least_one))
                }
            } else {
                showMessage(getString(R.string.error_add_at_least_one))
            }
