...
class StockRequisitionViewAllActivity : BaseActivity() {
    ...
    private fun DetailsBottomsheet(pastReqDetailsList:PastReqDetailsList, context: Context) {
        ...
        pastReqDetailsList.created_at?.let {
            ...
            d_binding.orderdate.text = getString(R.string.stock_ordered_at, DateTimeFormatting.formatOrderdate(it, localizationData.timezone))

        }
        pastReqDetailsList.approve_date?.let {
            d_binding.approvedate.isVisible = true
            d_binding.approvedate.text = getString(R.string.stock_approved_at, DateTimeFormatting.formatApprovedate(it, localizationData.timezone))
        }

        pastReqDetailsList.receive_date?.let {
            d_binding.receivedate.isVisible = true
            d_binding.receivedate.text = getString(R.string.stock_received_at, DateTimeFormatting.formatReceivedate(it, localizationData.timezone))
        }

        pastReqDetailsList.dispatch_date?.let {
            d_binding.dispatchdate.isVisible = true
            d_binding.dispatchdate.text = getString(R.string.stock_dispatched_at, DateTimeFormatting.formatDispatchDate(it, localizationData.timezone))
        }
    ...
    private fun enableBackButton() {
        ...
        //set actionbar title
        actionbar!!.title = getString(R.string.stock_requisition)
        //set back button
