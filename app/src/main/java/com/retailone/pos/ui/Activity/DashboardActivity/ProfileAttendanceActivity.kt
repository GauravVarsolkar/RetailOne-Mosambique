...
class ProfileAttendanceActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        attendanceViewmodel.attendance_LiveData.observe(this){
            if(it.monthly_attendance.isNotEmpty()){
                ...
                showMessage(getString(R.string.error_attendance_not_found))
            }
    ...
    private fun enableBackButton() {
        ...
        //set actionbar title
        actionbar!!.title = getString(R.string.profile_attendance)
        //set back button
