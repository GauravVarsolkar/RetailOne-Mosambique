...
class SaleCorrectionActivity : BaseActivity(), OnReturnQuantityChangeListener {
        ...
        returnsale_viewmodel.returnitem_liveData.observe(this){
            if(it.data.isNotEmpty()){
                ...
                if(it.data[0].total_refunded_amount>0){
                    showMessage(getString(R.string.return_error_already_returned))
...
//                   callReturnAPI()
//                }else{
//                showMessage(getString(R.string.return_error_no_items))
//                }
//            }else{
