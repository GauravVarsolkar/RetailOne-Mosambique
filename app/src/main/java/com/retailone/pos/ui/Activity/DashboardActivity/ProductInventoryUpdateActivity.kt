...
class ProductInventoryUpdateActivity : BaseActivity() {
        ...
        binding.nextlayout.setOnClickListener {
            ...
            if (updatedList.isNotEmpty()) {
                ...
                if (!updatedList.any { it.cart_quantity.toInt() == 0 }) {
                    ...
                    showMessage(getString(R.string.pi_error_qty_zero_empty))
                }

            } else {
                showMessage(getString(R.string.pi_error_select_at_least_one))
            }
    ...
    private fun getCurrentTime() {
        ...
        binding.calenderText.text = getString(R.string.pi_stock_taking_date_prefix, formattedDateTime)
    }
    ...
    private fun enableBackButton() {
        ...
        //set actionbar title
        actionbar!!.title = getString(R.string.product_inventory)
        //set back button
